...
Begin VB.Form frm_mejoraconsi 
   ...
   Begin VB.CommandButton Command1 
      ...
      Height          =   495
      Left            =   3480
      Picture         =   "frm_mejoraconsi.frx":0442
      Style           =   1  'Graphical
      TabIndex        =   29
   ...
   Begin MSDBGrid.DBGrid DBGrid1 
      Bindings        =   "frm_mejoraconsi.frx":0884
      Height          =   1575
      Left            =   120
      OleObjectBlob   =   "frm_mejoraconsi.frx":089D
      TabIndex        =   18
      Top             =   6120
      Width           =   9735
   End
   Begin VB.CommandButton b_cancela 
      ...
      Height          =   495
      Left            =   2640
      Picture         =   "frm_mejoraconsi.frx":15C8
      Style           =   1  'Graphical
      TabIndex        =   17
   ...
   Begin VB.CommandButton b_graba 
      ...
      Height          =   495
      Left            =   1800
      Picture         =   "frm_mejoraconsi.frx":1B52
      Style           =   1  'Graphical
      TabIndex        =   16
   ...
   Begin VB.CommandButton b_modif 
      ...
      Height          =   495
      Left            =   960
      Picture         =   "frm_mejoraconsi.frx":20DC
      Style           =   1  'Graphical
      TabIndex        =   15
   ...
   Begin VB.CommandButton b_nuevo 
      ...
      Height          =   495
      Left            =   120
      Picture         =   "frm_mejoraconsi.frx":2666
      Style           =   1  'Graphical
      TabIndex        =   14
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.ComboBox Combo1 
         ...
         EndProperty
         Height          =   405
         ItemData        =   "frm_mejoraconsi.frx":2BF0
         Left            =   2280
         List            =   "frm_mejoraconsi.frx":2C03
   ...
   Begin VB.Image Image1 
      Height          =   975
      Left            =   4320
      Picture         =   "frm_mejoraconsi.frx":2C42
      Stretch         =   -1  'True
      Top             =   5640
      Width           =   1935
   End
End
Attribute VB_Name = "frm_mejoraconsi"
...
frm_mejorai.Frame1.Enabled = True
...
Else
    If frm_mejorai.Combo2.ListIndex >= 0 And WElusuario <> "JFERNAN" Then
       MsgBox "ATENCION! EL REGISTRO YA FUE CERRADO", vbInformation, "Mejora continua"
       frm_mejora.Frame1.Enabled = False
    Else
    
        If WElusuario = frm_mejorai.data_accion.Recordset("cl_nom_sup") Then
            XAlta = 0
            Frame1.Enabled = True
...
frm_mejorai.Frame1.Enabled = True
If frm_mejorai.Combo2.ListIndex >= 0 Then
   MsgBox "ATENCION! EL REGISTRO YA FUE CERRADO", vbInformation, "Mejora continua"
   frm_mejorai.Frame1.Enabled = False
Else
   frm_mejorai.Frame1.Enabled = False
...
labnro.Caption = frm_mejorai.txt_nro.Text
labtit.Caption = frm_mejorai.txt_encab.Text
...
Else
    ...
    data_his2.Refresh
    Data1.Connect = "odbc;dsn=" & Xconexrmt & ";"
    Data1.RecordSource = "Select * from infor_sol where cl_nomcobr =" & 2
    Data1.Refresh
