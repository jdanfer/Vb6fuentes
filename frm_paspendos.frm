...
Begin VB.Form frm_paspendos 
   BackColor       =   &H00404040&
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Pasaje de PENDIENTES en arqueo"
   ClientHeight    =   4815
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   7335
   Icon            =   "frm_paspendos.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   4815
   ...
   Begin VB.CommandButton btn_salir 
      ...
      Height          =   495
      Left            =   1440
      Picture         =   "frm_paspendos.frx":0442
      Style           =   1  'Graphical
      TabIndex        =   15
      ToolTipText     =   "Salir"
      Top             =   840
   ...
   Begin VB.Frame Frame1 
      BackColor       =   &H00C0E0FF&
      Caption         =   "Pasaje de recibos PENDIENTES"
      Enabled         =   0   'False
      BeginProperty Font 
         Name            =   "Arial"
         Size            =   14.25
      ...
      Begin VB.CommandButton btn_fin 
         ...
         Height          =   615
         Left            =   120
         Picture         =   "frm_paspendos.frx":09CC
         Style           =   1  'Graphical
         TabIndex        =   13
         Top             =   2280
         Width           =   1335
   ...
   Begin VB.CommandButton btn_acep 
      ...
      Height          =   495
      Left            =   120
      Picture         =   "frm_paspendos.frx":0E0E
      Style           =   1  'Graphical
      TabIndex        =   3
      ToolTipText     =   "Aceptar"
      Top             =   840
   ...
   Begin VB.Image Image1 
      Height          =   1095
      Left            =   4800
      Picture         =   "frm_paspendos.frx":1398
      Stretch         =   -1  'True
      Top             =   960
      Width           =   1815
   End
End
Attribute VB_Name = "frm_paspendos"
...
'   data_cob.Recordset.FindFirst "cb_numero =" & txt_nrocobr.Text
   ...
   If data_arqueo.Recordset.RecordCount > 0 Then
      If data_arqueo.Recordset("cob") = txt_nrocobr.Text Then
         If IsNull(data_arqueo.Recordset("arqueo")) = False Then
            If data_arqueo.Recordset("arqueo") = "P" Then
            Else
'               data_arqueo.Recordset.Edit
               data_arqueo.Recordset("arqueo") = "P"
               ...
               If data_deu.Recordset.RecordCount > 0 Then
                  If IsNull(data_deu.Recordset("fecha_pago")) = False Then
                     data_lin.RecordSource = "Select * from linmmdd where cod_cli =" & txt_mat.Text & " and mes_paga =" & data_deu.Recordset("mes") & " and ano_paga =" & data_deu.Recordset("ano")
                     data_lin.Refresh
                     If data_lin.Recordset.RecordCount > 0 Then
                        ...
                        If data_arqueo.Recordset("arqueo") = "D" Then
                        Else
'                           data_arqueo.Recordset.Edit
                           data_arqueo.Recordset("arqueo") = "D"
                           data_arqueo.Recordset("fecha") = Format(Date, "dd/mm/yyyy")
                           data_arqueo.Recordset("usuar") = WElusuario
                           data_arqueo.Recordset.Update
                        End If
                     Else
...
'                           data_arqueo.Recordset.Edit
               ...
               Else
                  ...
                  data_deu.Recordset("origen") = Xorigen = "Pendiente..." & Trim(str(data_arqueo.Recordset("mes"))) & "/" & Trim(str(data_arqueo.Recordset("ano")))
                  ...
                  data_deu.Recordset.Update
                  data_cli.RecordSource = "Select * from clientes where cl_codigo =" & data_arqueo.Recordset("matricula")
                  data_cli.Refresh
                  If data_cli.Recordset.RecordCount > 0 Then
...
Yaestapas:
          If Err.Number = 3197 Then
             MsgBox "El RECIBO ya está pasado cómo PENDIENTE", vbInformation, "Pendientes"
          Else
