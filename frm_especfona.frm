...
Begin VB.Form frm_especfona 
   BackColor       =   &H00404000&
   Caption         =   "Formulario de agenda para FONASA"
   ClientHeight    =   8595
   ClientLeft      =   120
   ClientTop       =   450
   ClientWidth     =   14445
   Icon            =   "frm_especfona.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   ScaleHeight     =   8595
   ScaleWidth      =   14445
   ...
   Begin VB.ComboBox Combo1 
      ...
      ForeColor       =   &H00FFFFFF&
      Height          =   315
      ItemData        =   "frm_especfona.frx":058A
      Left            =   120
      List            =   "frm_especfona.frx":0594
   ...
   Begin VB.CommandButton modifConsultorio 
      ...
      Height          =   495
      Left            =   5880
      Picture         =   "frm_especfona.frx":05C0
      Style           =   1  'Graphical
      TabIndex        =   86
   ...
   Begin VB.CommandButton Command2 
      ...
      Height          =   375
      Left            =   120
      Picture         =   "frm_especfona.frx":35F0
      Style           =   1  'Graphical
      TabIndex        =   80
      Top             =   7920
      Visible         =   0   'False
   ...
   Begin VB.Frame Frame4 
      ...
      Begin VB.CommandButton b_impcons 
         ...
         Height          =   375
         Left            =   1320
         Picture         =   "frm_especfona.frx":3B7A
         Style           =   1  'Graphical
         TabIndex        =   71
      ...
      Begin VB.CommandButton b_elianota 
         ...
         Height          =   375
         Left            =   720
         Picture         =   "frm_especfona.frx":4104
         Style           =   1  'Graphical
         TabIndex        =   70
         Top             =   2280
         Width           =   375
      ...
      Begin VB.CommandButton b_buscapac 
         ...
         Height          =   375
         Left            =   7080
         Picture         =   "frm_especfona.frx":468E
         Style           =   1  'Graphical
         TabIndex        =   64
      ...
      Begin VB.CommandButton b_modpac 
         ...
         Height          =   375
         Left            =   720
         Picture         =   "frm_especfona.frx":4C18
         Style           =   1  'Graphical
         TabIndex        =   63
      ...
      Begin VB.CommandButton b_agrega 
         ...
         Height          =   375
         Left            =   120
         Picture         =   "frm_especfona.frx":51A2
         Style           =   1  'Graphical
         TabIndex        =   62
      ...
      Begin VB.ComboBox cbotipcons 
         ...
         ForeColor       =   &H00E0E0E0&
         Height          =   315
         ItemData        =   "frm_especfona.frx":572C
         Left            =   1680
         List            =   "frm_especfona.frx":572E
         Style           =   2  'Dropdown List
         TabIndex        =   61
         Top             =   1440
         Width           =   3855
      ...
      Begin VB.ComboBox cbosino 
         ...
         ForeColor       =   &H00E0E0E0&
         Height          =   315
         ItemData        =   "frm_especfona.frx":5730
         Left            =   6720
         List            =   "frm_especfona.frx":573A
         Style           =   2  'Dropdown List
         TabIndex        =   58
         Top             =   1440
         Width           =   735
   ...
   Begin VB.CommandButton b_elifec 
      ...
      Height          =   495
      Left            =   5160
      Picture         =   "frm_especfona.frx":5746
      Style           =   1  'Graphical
      TabIndex        =   41
   ...
   Begin VB.Frame Frame3 
      ...
      Begin VB.CommandButton b_cierramed 
         ...
         Height          =   375
         Left            =   6240
         Picture         =   "frm_especfona.frx":5CD0
         Style           =   1  'Graphical
         TabIndex        =   39
         Top             =   3720
         Width           =   375
      ...
      Begin MSDBGrid.DBGrid DBGrid2 
         Bindings        =   "frm_especfona.frx":625A
         Height          =   1575
         Left            =   120
         OleObjectBlob   =   "frm_especfona.frx":6279
         TabIndex        =   38
         Top             =   2520
         Width           =   6135
      End
      Begin VB.CommandButton b_canmed 
         ...
         Height          =   375
         Left            =   1920
         Picture         =   "frm_especfona.frx":6C64
         Style           =   1  'Graphical
         TabIndex        =   37
         Top             =   2160
         Width           =   375
      ...
      Begin VB.CommandButton b_grabmed 
         ...
         Height          =   375
         Left            =   1320
         Picture         =   "frm_especfona.frx":71EE
         Style           =   1  'Graphical
         TabIndex        =   36
         Top             =   2160
         Width           =   375
      ...
      Begin VB.CommandButton b_modmed 
         ...
         Height          =   375
         Left            =   720
         Picture         =   "frm_especfona.frx":7778
         Style           =   1  'Graphical
         TabIndex        =   35
         Top             =   2160
         Width           =   375
      ...
      Begin VB.CommandButton b_altamed 
         ...
         Height          =   375
         Left            =   120
         Picture         =   "frm_especfona.frx":7D02
         Style           =   1  'Graphical
         TabIndex        =   34
         Top             =   2160
         Width           =   375
      ...
      Begin VB.ComboBox cboespec 
         ...
         ForeColor       =   &H00FFFFFF&
         Height          =   315
         ItemData        =   "frm_especfona.frx":828C
         Left            =   1800
         List            =   "frm_especfona.frx":82DE
         Style           =   2  'Dropdown List
         TabIndex        =   31
         Top             =   1200
         Width           =   3975
   ...
   Begin VB.CommandButton b_infos 
      ...
      Height          =   495
      Left            =   4440
      Picture         =   "frm_especfona.frx":8445
      Style           =   1  'Graphical
      TabIndex        =   24
   ...
   Begin VB.CommandButton b_edimed 
      ...
      Height          =   495
      Left            =   3720
      MouseIcon       =   "frm_especfona.frx":89CF
      MousePointer    =   99  'Custom
      Picture         =   "frm_especfona.frx":8F59
      Style           =   1  'Graphical
      TabIndex        =   23
   ...
   Begin VB.Frame Frame2 
      ...
      Begin VB.CommandButton b_cancecons 
         ...
         Height          =   495
         Left            =   5520
         Picture         =   "frm_especfona.frx":94E3
         Style           =   1  'Graphical
         TabIndex        =   72
      ...
      Begin MSDBGrid.DBGrid DBGrid3 
         Bindings        =   "frm_especfona.frx":9A6D
         Height          =   2415
         Left            =   120
         OleObjectBlob   =   "frm_especfona.frx":9A87
         TabIndex        =   40
         Top             =   240
         Width           =   7215
      End
      ...
      Begin VB.CommandButton b_nuevafecha 
         ...
         Height          =   495
         Left            =   120
         MouseIcon       =   "frm_especfona.frx":A612
         MousePointer    =   99  'Custom
         Picture         =   "frm_especfona.frx":AB9C
         Style           =   1  'Graphical
         TabIndex        =   21
         Top             =   2640
         Width           =   1815
   ...
   Begin MSDBGrid.DBGrid DBGrid1 
      Bindings        =   "frm_especfona.frx":B126
      Height          =   3855
      Left            =   120
      OleObjectBlob   =   "frm_especfona.frx":B13A
      TabIndex        =   19
      Top             =   4560
      Width           =   6615
   End
   ...
   Begin VB.CommandButton b_elim 
      ...
      Height          =   495
      Left            =   3000
      Picture         =   "frm_especfona.frx":BE75
      Style           =   1  'Graphical
      TabIndex        =   17
   ...
   Begin VB.CommandButton b_cance 
      ...
      Height          =   495
      Left            =   2280
      Picture         =   "frm_especfona.frx":C3FF
      Style           =   1  'Graphical
      TabIndex        =   16
   ...
   Begin VB.CommandButton b_graba 
      ...
      Height          =   495
      Left            =   1560
      Picture         =   "frm_especfona.frx":C989
      Style           =   1  'Graphical
      TabIndex        =   15
   ...
   Begin VB.CommandButton b_modif 
      ...
      Height          =   495
      Left            =   840
      Picture         =   "frm_especfona.frx":CF13
      Style           =   1  'Graphical
      TabIndex        =   14
   ...
   Begin VB.CommandButton b_nuevo 
      ...
      Height          =   495
      Left            =   120
      Picture         =   "frm_especfona.frx":D49D
      Style           =   1  'Graphical
      TabIndex        =   13
   ...
   Begin MSDBGrid.DBGrid DBGrid4 
      Height          =   855
      Left            =   3960
      OleObjectBlob   =   "frm_especfona.frx":DA27
      TabIndex        =   85
      Top             =   5280
      Width           =   5175
   End
   Begin VB.Image Image1 
      Height          =   1095
      Left            =   5760
      Picture         =   "frm_especfona.frx":E596
      Stretch         =   -1  'True
      Top             =   3600
      Width           =   1335
   End
End
Attribute VB_Name = "frm_especfona"
          ...
          If ListView1.ListItems.Item(ListView1.SelectedItem.index).Checked = True Then
             ...
             If data_lista.Recordset.RecordCount > 0 Then
                If IsNull(data_lista.Recordset("nom_pac")) = False And IsNull(data_lista.Recordset("ced_pac")) = False Then
                   MsgBox "Ya existe un paciente anotado con este número, verifique!!", vbCritical
                Else
...
Listatodo = MsgBox("Desea listar TODAS las MUTUALISTAS y BASES ?", vbInformation + vbYesNo)
If Listatodo = vbYes Then
   data_lista.RecordSource = "select * from t_fechas where fecha ='" & data_cabfec.Recordset("fecha") & "' and especial ='" & "AFILIACIONES" & "' order by base,nro"
Else
   data_lista.RecordSource = "select * from t_fechas where fecha ='" & data_cabfec.Recordset("fecha") & "' and cod_cons =" & data_cabfec.Recordset("cod_cons") & " order by nro"
End If
...
'      End If
      ...
      data_lista.Recordset.MoveNext
   Loop
   frm_especfona.MousePointer = 0
   data_inf.RecordSource = "Select * from lista"
   data_inf.Refresh
   frm_especialistas.MousePointer = 0
   MsgBox "Proceso terminado", vbInformation
   cr1.ReportFileName = App.path & "\inflistanewf.rpt"
   cr1.Action = 1
...
Dim Xnropac, Xcodconscrea As Integer
...
ConfirmarCreacion: 'cuando confirma creacion de fecha
    ...
    If t_especsel.Text = "CIRUGIA" Or _
       ...
       data_cabfec.Recordset.Update
    Else
       If t_especsel.Text = "ZOLESSI NELSON" Then
          Xlafecanota = CDate(Xfecstr) - 10
          data_cabfec.Recordset("fecha_anota") = Format(Xlafecanota, "dd/mm/yyyy")
          data_cabfec.Recordset.Update
       Else
...
data_fechas.Connect = "ODBC;DSN=sappespecial;"

data_conscli.Connect = "odbc;dsn=" & Xconexrmt & ";"

data_borrados.Connect = "ODBC;DSN=sappespecial;"

data_cabfec.Connect = "ODBC;DSN=sappespecial;"


data_veoesp.Connect = "ODBC;DSN=sappespecial;"
data_veoesp.RecordSource = "Select * from t_espec where especialidad ='" & "AFILIACIONES" & "' order by base,nombre"
data_veoesp.Refresh

data_lista.Connect = "ODBC;DSN=sappespecial;"
...
data_base.Connect = "ODBC;DSN=sappespecial;"
...
data_medicos.Connect = "ODBC;DSN=sappespecial;"
...
If data_medicos.Recordset.RecordCount > 0 Then
   ...
   Loop
End If
If WElusuario = "SDOMINGUEZ" Or WElusuario = "JFERNAN" Or WElusuario = "AACUÑA" Or WElusuario = "COMPUTOS" Or WElusuario = "SMPEREZ" Then
...
Else
   ...
   End If
End If
If WElusuario = "SDOMINGUEZ" Or WElusuario = "JFERNAN" Or WElusuario = "MARIAROSA" Or WElusuario = "MSANCHEZ" Or welusuaario = "JONATHAN" Or WElusuario = "GFERNANDEZ" Or WElusuario = "AACUÑA" Or WElusuario = "SMPEREZ" Then
Else
