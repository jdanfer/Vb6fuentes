...
Begin VB.Form frm_infsolmark 
   BackColor       =   &H0080C0FF&
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Informes solicitudes a Marketing"
   ClientHeight    =   4245
   ClientLeft      =   45
   ClientTop       =   345
   ClientWidth     =   4710
   ...
   Begin VB.CommandButton Command2 
      ...
      Height          =   495
      Left            =   3960
      Picture         =   "frm_infsolmark.frx":0442
      Style           =   1  'Graphical
      TabIndex        =   8
      ToolTipText     =   "Salir"
      Top             =   3480
   ...
   Begin VB.CommandButton Command1 
      ...
      Height          =   495
      Left            =   240
      Picture         =   "frm_infsolmark.frx":09CC
      Style           =   1  'Graphical
      TabIndex        =   7
   ...
   Begin VB.Image Image1 
      Height          =   615
      Left            =   1560
      Picture         =   "frm_infsolmark.frx":0F56
      Stretch         =   -1  'True
      Top             =   3600
      Width           =   1455
   End
End
Attribute VB_Name = "frm_infsolmark"
...
If mfdd.Text <> "__/__/____" And mfhh.Text <> "__/__/____" Then
   If Option1.Value = True Then
      If ControlUsuario("Marketing") = 1 Then
         data_reg.RecordSource = "Select * from env_soc where cl_ter_vto =" & 8 & " And cl_fultmov >=#" & Format(mfdd.Text, "yyyy/mm/dd") & "# and cl_fultmov <=#" & Format(mfhh.Text, "yyyy/mm/dd") & "#"
         data_reg.Refresh
      Else
         data_reg.RecordSource = "Select * from env_soc where cl_ter_vto =" & 8 & " And cl_fultmov >=#" & Format(mfdd.Text, "yyyy/mm/dd") & "# and cl_fultmov <=#" & Format(mfhh.Text, "yyyy/mm/dd") & "# and cl_nom_sup ='" & WElusuario & "'"
         data_reg.Refresh
      End If
   Else
      If ControlUsuario("Marketing") = 1 Then
         data_reg.RecordSource = "Select * from env_soc where cl_ter_vto =" & 8 & " And cl_fnac >=#" & Format(mfdd.Text, "yyyy/mm/dd") & "# and cl_fnac <=#" & Format(mfhh.Text, "yyyy/mm/dd") & "#"
         data_reg.Refresh
      Else
         data_reg.RecordSource = "Select * from env_soc where cl_ter_vto =" & 8 & " And cl_fnac >=#" & Format(mfdd.Text, "yyyy/mm/dd") & "# and cl_fnac <=#" & Format(mfhh.Text, "yyyy/mm/dd") & "# and cl_nom_sup ='" & WElusuario & "'"
         data_reg.Refresh
      End If
   End If
   If data_reg.Recordset.RecordCount > 0 Then
      ...
      If Option1.Value = True Then
         ...
         cr1.ReportTitle = "SOLICITUDES CUMPLIDAS POR MARKETING A USUARIOS DESDE: " & mfdd.Text & " HASTA: " & mfhh.Text
         cr1.Action = 1
      ...
      If Option2.Value = True Then
         ...
         cr1.ReportTitle = "SOLICITUDES SIN CUMPLIR POR MARKETING DESDE: " & mfdd.Text & " HASTA: " & mfhh.Text
         cr1.Action = 1
      ...
      If Option3.Value = True Then
         ...
         cr1.ReportTitle = "SOLICITUDES TOTALES REALIZADAS A MARKETING DESDE: " & mfdd.Text & " HASTA: " & mfhh.Text
         cr1.Action = 1
