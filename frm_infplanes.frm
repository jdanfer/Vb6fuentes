...
Begin VB.Form frm_infplanes 
   BackColor       =   &H00808000&
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Informes Planes de Acción"
   ClientHeight    =   4755
   ClientLeft      =   45
   ClientTop       =   345
   ClientWidth     =   6060
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.ComboBox Combo1 
         Height          =   390
         ItemData        =   "frm_infplanes.frx":0442
         Left            =   1800
         List            =   "frm_infplanes.frx":044F
         Style           =   2  'Dropdown List
         TabIndex        =   5
         Top             =   1200
         Width           =   3375
   ...
   End
End
Attribute VB_Name = "frm_infplanes"
...
data_busca.RecordSource = "Select * from infor_sol where cl_val2 =" & 7 & " and estado =" & 99 & " and cl_nomcobr =" & 3
data_busca.Refresh
data_acc.RecordSource = "Select * from infor_sol where cl_val2 =" & 7 & " and cl_nomcobr =" & 3
data_acc.Refresh
...
'            If Not data_acc.Recordset.NoMatch Then
            data_acc.RecordSource = "Select * from infor_sol where cl_val2 =" & 7 & " and estado =" & data_busca.Recordset("cl_nrovend") & " and cl_nomcobr =" & 3
            data_acc.Refresh
...
'            If Not data_acc.Recordset.NoMatch Then
   ...
   Loop
End If
data_busca.RecordSource = "Select * from infor_sol where cl_val2 =" & 7 & " and cl_nomcobr =" & 3
data_busca.Refresh
   ...
   If mh.Text <> "__/__/____" Then
      ...
      If Combo1.ListIndex = 0 Then
         If Option3.value = True Then
            If Xelu = "" Then
               data_acc.RecordSource = "Select * from infor_sol where cl_val2 =" & 7 & " and estado <>" & 99 & " and cl_fnac >=#" & Format(md.Text, "yyyy/mm/dd") & "# and cl_fnac <=#" & Format(mh.Text, "yyyy/mm/dd") & "# and cl_atrasop =" & 1 & " and cl_nomcobr =" & 3
               data_acc.Refresh
            Else
               data_acc.RecordSource = "Select * from infor_sol where cl_val2 =" & 7 & " and estado <>" & 99 & " and cl_fnac >=#" & Format(md.Text, "yyyy/mm/dd") & "# and cl_fnac <=#" & Format(mh.Text, "yyyy/mm/dd") & "# and cl_atrasop =" & 1 & " and cl_nomcobr =" & 3 & " and cl_nom_sup ='" & Xelu & "'"
               data_acc.Refresh
            End If
         Else
            If Option4.value = True Then
               If Xelu = "" Then
                  data_acc.RecordSource = "Select * from infor_sol where cl_val2 =" & 7 & " and estado <>" & 99 & " and cl_fnac >=#" & Format(md.Text, "yyyy/mm/dd") & "# and cl_fnac <=#" & Format(mh.Text, "yyyy/mm/dd") & "# and cl_atrasop =" & 2 & " and cl_nomcobr =" & 3
                  data_acc.Refresh
               Else
                  data_acc.RecordSource = "Select * from infor_sol where cl_val2 =" & 7 & " and estado <>" & 99 & " and cl_fnac >=#" & Format(md.Text, "yyyy/mm/dd") & "# and cl_fnac <=#" & Format(mh.Text, "yyyy/mm/dd") & "# and cl_atrasop =" & 2 & " and cl_nomcobr =" & 3 & " and cl_nom_sup ='" & Xelu & "'"
                  data_acc.Refresh
               End If
            Else
               If Option5.value = True Then
                  If Xelu = "" Then
                     data_acc.RecordSource = "Select * from infor_sol where cl_val2 =" & 7 & " and estado <>" & 99 & " and cl_fnac >=#" & Format(md.Text, "yyyy/mm/dd") & "# and cl_fnac <=#" & Format(mh.Text, "yyyy/mm/dd") & "# and cl_atrasop =" & 3 & " and cl_nomcobr =" & 3
                     data_acc.Refresh
                  Else
                     data_acc.RecordSource = "Select * from infor_sol where cl_val2 =" & 7 & " and estado <>" & 99 & " and cl_fnac >=#" & Format(md.Text, "yyyy/mm/dd") & "# and cl_fnac <=#" & Format(mh.Text, "yyyy/mm/dd") & "# and cl_atrasop =" & 3 & " and cl_nomcobr =" & 3 & " and cl_nom_sup ='" & Xelu & "'"
                     data_acc.Refresh
                  End If
               Else
                  If Xelu = "" Then
                     data_acc.RecordSource = "Select * from infor_sol where cl_val2 =" & 7 & " and estado <>" & 99 & " and cl_fnac >=#" & Format(md.Text, "yyyy/mm/dd") & "# and cl_fnac <=#" & Format(mh.Text, "yyyy/mm/dd") & "# and cl_nomcobr =" & 3
                     data_acc.Refresh
                  Else
                     data_acc.RecordSource = "Select * from infor_sol where cl_val2 =" & 7 & " and estado <>" & 99 & " and cl_fnac >=#" & Format(md.Text, "yyyy/mm/dd") & "# and cl_fnac <=#" & Format(mh.Text, "yyyy/mm/dd") & "# and cl_nomcobr =" & 3 & " and cl_nom_sup ='" & Xelu & "'"
                     data_acc.Refresh
                  End If
               End If
            End If
      ...
      Else
         If Combo1.ListIndex = 1 Then
            If Option3.value = True Then
               If Xelu = "" Then
                  data_acc.RecordSource = "Select * from infor_sol where cl_val2 =" & 7 & " and cl_fnac >=#" & Format(md.Text, "yyyy/mm/dd") & "# and cl_fnac <=#" & Format(mh.Text, "yyyy/mm/dd") & "# and cl_atrasop =" & 1 & " and cl_nomcobr =" & 3
                  data_acc.Refresh
               Else
                  data_acc.RecordSource = "Select * from infor_sol where cl_val2 =" & 7 & " and cl_fnac >=#" & Format(md.Text, "yyyy/mm/dd") & "# and cl_fnac <=#" & Format(mh.Text, "yyyy/mm/dd") & "# and cl_atrasop =" & 1 & " and cl_nomcobr =" & 3 & " and cl_nom_sup ='" & Xelu & "'"
                  data_acc.Refresh
               End If
            Else
               If Option4.value = True Then
                  If Xelu = "" Then
                     data_acc.RecordSource = "Select * from infor_sol where cl_val2 =" & 7 & " and cl_fnac >=#" & Format(md.Text, "yyyy/mm/dd") & "# and cl_fnac <=#" & Format(mh.Text, "yyyy/mm/dd") & "# and cl_atrasop =" & 2 & " and cl_nomcobr =" & 3
                     data_acc.Refresh
                  Else
                     data_acc.RecordSource = "Select * from infor_sol where cl_val2 =" & 7 & " and cl_fnac >=#" & Format(md.Text, "yyyy/mm/dd") & "# and cl_fnac <=#" & Format(mh.Text, "yyyy/mm/dd") & "# and cl_atrasop =" & 2 & " and cl_nomcobr =" & 3 & " and cl_nom_sup ='" & Xelu & "'"
                     data_acc.Refresh
                  End If
               Else
                  If Option5.value = True Then
                     If Xelu = "" Then
                        data_acc.RecordSource = "Select * from infor_sol where cl_val2 =" & 7 & " and cl_fnac >=#" & Format(md.Text, "yyyy/mm/dd") & "# and cl_fnac <=#" & Format(mh.Text, "yyyy/mm/dd") & "# and cl_atrasop =" & 3 & " and cl_nomcobr =" & 3
                        data_acc.Refresh
                     Else
                        data_acc.RecordSource = "Select * from infor_sol where cl_val2 =" & 7 & " and cl_fnac >=#" & Format(md.Text, "yyyy/mm/dd") & "# and cl_fnac <=#" & Format(mh.Text, "yyyy/mm/dd") & "# and cl_atrasop =" & 3 & " and cl_nomcobr =" & 3 & " and cl_nom_sup ='" & Xelu & "'"
                        data_acc.Refresh
                     End If
                  Else
                     If Xelu = "" Then
                        data_acc.RecordSource = "Select * from infor_sol where cl_val2 =" & 7 & " and cl_fnac >=#" & Format(md.Text, "yyyy/mm/dd") & "# and cl_fnac <=#" & Format(mh.Text, "yyyy/mm/dd") & "# and cl_nomcobr =" & 3
                        data_acc.Refresh
                     Else
                        data_acc.RecordSource = "Select * from infor_sol where cl_val2 =" & 7 & " and cl_fnac >=#" & Format(md.Text, "yyyy/mm/dd") & "# and cl_fnac <=#" & Format(mh.Text, "yyyy/mm/dd") & "# and cl_nomcobr =" & 3 & " and cl_nom_sup ='" & Xelu & "'"
                        data_acc.Refresh
                     End If
                  End If
               End If
...
''                                 data_inf.Recordset("estado") = 4
         ...
         If data_inf.Recordset.RecordCount > 0 Then
            If Combo1.ListIndex = 0 Then ''' todas
               data_inf.Recordset.MoveFirst
               Do While Not data_inf.Recordset.EOF
                  data_busca.RecordSource = "Select * from infor_sol where cl_nrovend =" & data_inf.Recordset("cl_codigo") & " and cl_nomcobr =" & 3
                  data_busca.Refresh
                  If data_busca.Recordset.RecordCount > 0 Then
                     data_busca.Recordset.MoveFirst
                     Do While Not data_busca.Recordset.EOF
...
data_inf.Refresh
data_busca.DatabaseName = App.Path & "\sapp.mdb"
