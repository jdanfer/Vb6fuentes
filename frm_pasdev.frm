...
Begin VB.Form frm_pasdev 
   BackColor       =   &H00C00000&
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Pasaje de DEVOLUCIONES en arqueo"
   ClientHeight    =   4815
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   7335
   Icon            =   "frm_pasdev.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   4815
   ...
   Begin VB.Frame Frame1 
      BackColor       =   &H00FFC0FF&
      Caption         =   "Pasaje de recibos DEVOLUCION"
      Enabled         =   0   'False
      BeginProperty Font 
         Name            =   "Arial"
         Size            =   12
   ...
   Begin VB.Image Image1 
      Height          =   1215
      Left            =   3120
      Picture         =   "frm_pasdev.frx":1398
      Stretch         =   -1  'True
      Top             =   960
      Width           =   2775
   End
End
Attribute VB_Name = "frm_pasdev"
...
Dim Xdeseasi As String

If Check1.Value = 1 Then
   Xdeseasi = MsgBox(WElusuario & " está seguro que desea borrar la deuda?", vbExclamation + vbYesNo, "Arqueos")
   If Xdeseasi = vbYes Then
   Else
      Check1.Value = 0
   End If
End If
...
'               data_arqueo.Recordset.Edit
               ...
               If data_deu.Recordset.RecordCount > 0 Then
                  If Check1.Value = 1 Then
                     ...
                     Else
                        data_deu.Recordset("fecha_pago") = Date
