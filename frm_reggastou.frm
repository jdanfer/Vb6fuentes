...
Begin VB.Form frm_reggasto 
   ...
   Begin VB.CommandButton b_busca 
      ...
      Height          =   495
      Left            =   3600
      Picture         =   "frm_reggastou.frx":0442
      Style           =   1  'Graphical
      TabIndex        =   18
      ToolTipText     =   "Buscar"
      Top             =   6360
   ...
   Begin VB.CommandButton Command7 
      ...
      Height          =   495
      Left            =   7800
      Picture         =   "frm_reggastou.frx":09CC
      Style           =   1  'Graphical
      TabIndex        =   17
      ToolTipText     =   "Salir"
      Top             =   6360
   ...
   Begin VB.CommandButton b_cance 
      ...
      Height          =   495
      Left            =   2760
      Picture         =   "frm_reggastou.frx":0F56
      Style           =   1  'Graphical
      TabIndex        =   16
   ...
   Begin VB.CommandButton b_graba 
      ...
      Height          =   495
      Left            =   1920
      Picture         =   "frm_reggastou.frx":14E0
      Style           =   1  'Graphical
      TabIndex        =   15
   ...
   Begin VB.CommandButton b_mod 
      ...
      Height          =   495
      Left            =   1080
      Picture         =   "frm_reggastou.frx":1A6A
      Style           =   1  'Graphical
      TabIndex        =   14
   ...
   Begin VB.CommandButton b_alta 
      ...
      Height          =   495
      Left            =   240
      Picture         =   "frm_reggastou.frx":1FF4
      Style           =   1  'Graphical
      TabIndex        =   13
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.CommandButton b_ed 
         ...
         Height          =   495
         Left            =   7440
         Picture         =   "frm_reggastou.frx":257E
         Style           =   1  'Graphical
         TabIndex        =   31
         ToolTipText     =   "Graba la modificación realizada en un ítem de una entrega"
         Top             =   3360
         Width           =   495
      End
      ...
      Begin MSDBGrid.DBGrid DBGrid1 
         Bindings        =   "frm_reggastou.frx":2B08
         Height          =   1335
         Left            =   240
         OleObjectBlob   =   "frm_reggastou.frx":2B22
         TabIndex        =   29
         Top             =   4440
         Width           =   7695
      End
      Begin VB.CommandButton b_el 
         ...
         Height          =   495
         Left            =   4800
         Picture         =   "frm_reggastou.frx":369D
         Style           =   1  'Graphical
         TabIndex        =   28
      ...
      Begin VB.CommandButton b_gr 
         ...
         Height          =   495
         Left            =   3960
         Picture         =   "frm_reggastou.frx":3C27
         Style           =   1  'Graphical
         TabIndex        =   27
      ...
      Begin VB.CommandButton b_comienza 
         Height          =   615
         Left            =   2040
         Picture         =   "frm_reggastou.frx":41B1
         Style           =   1  'Graphical
         TabIndex        =   26
   ...
   Begin VB.Image Image1 
      Height          =   495
      Left            =   4800
      Picture         =   "frm_reggastou.frx":45F3
      Stretch         =   -1  'True
      Top             =   6480
      Width           =   2415
   End
...
data_gasto.Recordset("descrip") = Mid(labdesc.Caption, 1, 80)
data_gasto.Recordset("prec") = 0
If t_cant.Text = "" Then
   t_cant.Text = 0
End If
...
'   data_sto.Recordset.EditMode
   data_sto.Recordset("actual") = data_sto.Recordset("actual") - t_cant.Text + t_cantant.Text
