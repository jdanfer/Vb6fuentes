...
Begin VB.Form frm_labo 
   ...
   Begin VB.ComboBox Combo1 
      Height          =   360
      ItemData        =   "frm_labo.frx":09CC
      Left            =   2160
      List            =   "frm_labo.frx":0A0C
      TabIndex        =   31
      Text            =   "Combo1"
      Top             =   1560
      Width           =   3735
   ...
   Begin MSDBGrid.DBGrid DBGrid1 
      Bindings        =   "frm_labo.frx":3CB7
      Height          =   1815
      Left            =   120
      OleObjectBlob   =   "frm_labo.frx":3CCB
      TabIndex        =   0
      Top             =   3600
      Width           =   11415
   End
