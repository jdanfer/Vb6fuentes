...
Begin VB.Form Form1 
   ...
   Begin VB.CheckBox Check1 
      BackColor       =   &H00C00000&
      Caption         =   "Cargar a Documentos de RX"
      ForeColor       =   &H00FFFFFF&
      Height          =   375
      Left            =   240
      TabIndex        =   9
   ...
   Begin VB.CommandButton Command2 
      ...
      Height          =   735
      Left            =   7200
      Picture         =   "frm_ingarchivos.frx":058A
      Style           =   1  'Graphical
      TabIndex        =   7
      Top             =   1920
      Width           =   1215
   ...
   Begin VB.CommandButton Command1 
      ...
      Height          =   735
      Left            =   7200
      Picture         =   "frm_ingarchivos.frx":0B14
      Style           =   1  'Graphical
      TabIndex        =   6
      Top             =   720
      Width           =   1215
...
If pdfpath <> "" Then
   ...
   If Check1.Value = 1 Then
      Data1.Recordset("nro_rrhh") = Data1.Recordset("nro_rrhh") + 1
   Else
   ...
   If Check1.Value = 1 Then
      Adodc1.Recordset("id") = Data1.Recordset("nro_rrhh")
   Else
...
Adodc1.RecordSource = "Select * from archs where id =" & 3000011
Adodc1.Refresh
