...
Begin VB.Form frm_infstock 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.CheckBox Check1 
         BackColor       =   &H0080FFFF&
         Caption         =   "Solo registros de informática"
         Height          =   255
         Left            =   120
         TabIndex        =   16
         Top             =   4560
...
If Option1.Value = True Then
   If mfd.Text <> "__/__/____" And mfh.Text <> "__/__/____" Then
      ...
      Else
         If t_cli.Text <> "" Then
            If WElusuario = "JFERNAN" Or WElusuario = "COMPUTOS" Then
               data_sto.RecordSource = "select gastos.fecha,gastos.codprod,gastos.descrip,gastos.descrip2,gastos.codcli,gastos.nomcli,gastos.cant,stock.preuni,stock.grupo from gastos inner join stock on gastos.codprod=stock.id where fecha >='" & Format(mfd.Text, "yyyy-mm-dd") & "' and fecha <='" & Format(mfh.Text, "yyyy-mm-dd") & "' and codcli =" & t_cli.Text & " and stock.grupo in (3) order by codprod"
            Else
               data_sto.RecordSource = "select gastos.fecha,gastos.codprod,gastos.descrip,gastos.descrip2,gastos.codcli,gastos.nomcli,gastos.cant,stock.preuni,stock.grupo from gastos inner join stock on gastos.codprod=stock.id where fecha >='" & Format(mfd.Text, "yyyy-mm-dd") & "' and fecha <='" & Format(mfh.Text, "yyyy-mm-dd") & "' and codcli =" & t_cli.Text & " and stock.grupo not in (3) order by codprod"
            End If
            data_sto.Refresh
         Else
            If Check1.Value = 1 Then
               data_sto.RecordSource = "Select * from Pedido_infor where fecha >='" & Format(mfd.Text, "yyyy-mm-dd") & "' and fecha <='" & Format(mfh.Text, "yyyy-mm-dd") & "'"
            Else
                If WElusuario = "JFERNAN" Or WElusuario = "COMPUTOS" Then
                   data_sto.RecordSource = "select gastos.fecha,gastos.codprod,gastos.descrip,gastos.descrip2,gastos.codcli,gastos.nomcli,gastos.cant,gastos.prec,stock.preuni," & _
                ...
                Else
                   data_sto.RecordSource = "select gastos.fecha,gastos.codprod,gastos.descrip,gastos.descrip2,gastos.codcli,gastos.nomcli,gastos.cant,stock.preuni,stock.grupo from gastos inner join stock on gastos.codprod=stock.id where fecha >='" & Format(mfd.Text, "yyyy-mm-dd") & "' and fecha <='" & Format(mfh.Text, "yyyy-mm-dd") & "' and stock.grupo not in (3)"
                End If
            End If
            data_sto.Refresh
         End If
      ...
      If data_sto.Recordset.RecordCount > 0 Then
         ...
         XCol = XCol + 1
         Xarchexel.Cells(Xlin, XCol) = "COD.AUT."
         ...
         Do While Not data_sto.Recordset.EOF
            ...
            XCol = XCol + 1
            If Check1.Value = 1 Then
               Xarchexel.Cells(Xlin, XCol) = data_sto.Recordset("ped_cod")
            Else
               Xarchexel.Cells(Xlin, XCol) = data_sto.Recordset("codprod")
            End If
            XCol = XCol + 1
            If Check1.Value = 1 Then
               Xarchexel.Cells(Xlin, XCol) = data_sto.Recordset("ped_desc")
            Else
               Xarchexel.Cells(Xlin, XCol) = data_sto.Recordset("descrip")
            End If
            XCol = XCol + 1
            If Check1.Value = 1 Then
               Xarchexel.Cells(Xlin, XCol) = data_sto.Recordset("base")
            Else
               Xarchexel.Cells(Xlin, XCol) = data_sto.Recordset("codcli")
            End If
            XCol = XCol + 1
            If Check1.Value = 1 Then
               Xarchexel.Cells(Xlin, XCol) = data_sto.Recordset("usuario")
            Else
               Xarchexel.Cells(Xlin, XCol) = data_sto.Recordset("nomcli")
            End If
            XCol = XCol + 1
            If Check1.Value = 1 Then
               Xarchexel.Cells(Xlin, XCol) = data_sto.Recordset("ped_cant")
            Else
...
'                  data_inf.Recordset.Update
            ...
            Else
               ...
               End If
            End If
            If IsNull(data_sto.Recordset("descrip2")) = False Then
               Xarchexel.Cells(Xlin, XCol) = data_sto.Recordset("descrip2")
            End If
            XCol = XCol + 1
