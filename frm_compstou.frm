...
Begin VB.Form frm_compsto 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.ComboBox cbomon 
         Height          =   360
         ItemData        =   "frm_compstou.frx":257E
         Left            =   2280
         List            =   "frm_compstou.frx":2588
      ...
      Begin VB.ComboBox Combo1 
         Height          =   360
         ItemData        =   "frm_compstou.frx":30AB
         Left            =   6240
         List            =   "frm_compstou.frx":30B8
         Style           =   2  'Dropdown List
         TabIndex        =   10
         Top             =   360
         Width           =   1935
